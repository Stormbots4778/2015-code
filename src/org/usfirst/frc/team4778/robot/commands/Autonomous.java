...
public class Autonomous extends CommandGroup {
    ...
    public  Autonomous() {
    	...
    	for (int i=0; i<2; i++) {
    		...
    		addSequential(new GoToHeight(9.00)); //TODO Added this
    		Timer.delay(0.2);
    		...
    		addSequential(new GoToHeight(8.00, 0.1)); //TODO Added this
    		addSequential(new ToggleGrips()); //TODO Added this
    		addSequential(new GoToHeight(0.16, 0.2, 0.65)); //TODO Added this
    	}
    		...
    		addSequential(new TurnToAngle(-60, false)); //Turn in preparation for scoring
    		Timer.delay(0.1);
    		addSequential(new ForwardToScore()); //Go forward into auto zone
    		Timer.delay(0.1);
    		//addSequential(new LiftZero()); //Set down the stack
    		addSequential(new GoToHeight(0.16, 0.2)); //TODO Added this
    		addSequential(new ToggleGrips());
